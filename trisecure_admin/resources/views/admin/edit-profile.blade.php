                        ...
                        <div class="col-lg-12">
                            <form action="{{ route('admin.account.update-profile') }}" method="post">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <input type="text" class="form-control" id="address" name="address" value="{{ auth()->guard('admin')->user()->address }}"/>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="phone_number" class="col-sm-12 col-lg-2 col-form-label">Phone number: <span class="required">*</span></label>
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ auth()->guard('admin')->user()->phone_number }}"/>
                                    </div>
                                </div>
                                <div class="mb-3 row">
